...
export default function ProofsPage() {
  ...
  const { _users, _feedback, refreshFeedback, addFeedback } =
      ...
      try {
        ...
        if (env.OPENZEPPELIN_AUTOTASK_WEBHOOK) {
          response = await fetch(env.OPENZEPPELIN_AUTOTASK_WEBHOOK, {
            ...
            body: JSON.stringify({
              abi: Reclaim.abi,
              address: env.RECLAIM_CONTRACT_ADDRESS,
  ...
  return (
    <>
      ...
      <Text pt="2" fontSize="md">
        ...
        that they are part of a group and that they are generating their own
        signals. Signals could be anonymous votes, leaks, reviews, or feedback.
      </Text>
